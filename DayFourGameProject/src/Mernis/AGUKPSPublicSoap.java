...
public class AGUKPSPublicSoap
{
    ...
    public AGUKPSPublicSoap(){}

    public AGUKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public AGUKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        AGUExtendedSoapSerializationEnvelope envelope= new AGUExtendedSoapSerializationEnvelope(AGUExtendedSoapSerializationEnvelope.VER11);

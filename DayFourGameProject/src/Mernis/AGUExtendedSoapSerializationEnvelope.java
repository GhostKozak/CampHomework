...
public class AGUExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(AGUDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new AGUStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static AGUDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static AGUDateTimeConverter dateTimeConverter = new AGUStandardDateTimeConverter();

    public AGUExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public AGUExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new AGUMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=AGUHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,AGUExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=AGUHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
